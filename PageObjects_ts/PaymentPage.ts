...
export class PaymentPage {
    ...
    dropDownCountryList:Locator;
    cvvTextBox: Locator;
    nameOnCardTextbox: Locator;
    applyCouponTextbox:Locator;
    ...
    async validateSelectedCOuntry(country: string) {
    ...
    async validateEmailId(emailId: string) {
